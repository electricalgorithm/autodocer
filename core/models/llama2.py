...
class LLaMa2Model(ModelBase):
    """
    This class implements the LLaMa2 model. It generates documentation for code
    using the LLaMa2 AI model.
    """
    ...
    def allowed_code_languages(self) -> list[CodeLanguage]:
        ...
        """
        return [CodeLanguage.PYTHON, CodeLanguage.RUST]
    ...
    def allowed_docs_languages(self) -> list[DocsLanguage]:
        ...
        """
        return [DocsLanguage.EN, DocsLanguage.TR]
